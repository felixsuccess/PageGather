 ...
 */
@Composable
fun BookStatusDistributionChart(
    timeRange: TimeRange,
    modifier: Modifier = Modifier,
    viewModel: BookStatusDistributionViewModel = hiltViewModel()
) {
    // 当时间范围改变时，重新加载数据
    LaunchedEffect(timeRange) {
        viewModel.loadBookStatusDataByDateRange(timeRange.startDate, timeRange.endDate)
    }
